...
const (
	defaultClaudeFingerprintUserAgent      = "claude-cli/2.1.154 (external, sdk-cli)"
	defaultClaudeFingerprintPackageVersion = "0.94.0"
	defaultClaudeFingerprintRuntimeVersion = "v24.3.0"
	defaultClaudeFingerprintOS             = "Windows"
...
// DefaultClaudeVersion returns the version string (e.g. "2.1.154") from the
