...
const (
	defaultClaudeFingerprintUserAgent      = "claude-cli/2.1.148 (external, cli)"
	defaultClaudeFingerprintPackageVersion = "0.98.0"
...
// DefaultClaudeVersion returns the version string (e.g. "2.1.148") from the
