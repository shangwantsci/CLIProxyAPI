...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/claude-mimicry-audit", s.mgmt.GetClaudeMimicryAudit)
		mgmt.GET("/claude-mimicry-events", s.mgmt.GetClaudeMimicryEvents)
		...
		mgmt.POST("/auth-files/claude-probe-jobs", s.mgmt.PostClaudeProbeJob)
		mgmt.GET("/auth-files/claude-probe-jobs/:id", s.mgmt.GetClaudeProbeJob)
		mgmt.POST("/auth-files/claude-probe-jobs/:id/cancel", s.mgmt.CancelClaudeProbeJob)
