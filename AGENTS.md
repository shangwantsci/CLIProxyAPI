...
- `docs/production-deployment-23.153.36.12.md` — standard production deployment and rollback flow; the filename is legacy, and the current server host is `154.29.158.193`. Read this before any server update. Never write SSH passwords, management passwords, API keys, Claude tokens, or proxy passwords into docs or commits.
